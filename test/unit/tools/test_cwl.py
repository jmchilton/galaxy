...
def test_proxy():
    print tool_proxy(_cwl_tool_path("draft2/cat1-tool.cwl"))
    print tool_proxy(_cwl_tool_path("draft2/cat3-tool.cwl"))
    print tool_proxy(_cwl_tool_path("draft2/env-tool1.cwl"))
    print tool_proxy(_cwl_tool_path("draft2/sorttool.cwl"))
    print tool_proxy(_cwl_tool_path("draft2/bwa-mem-tool.cwl"))
...
def test_cat1():
    cat1_tool = _cwl_tool_path("draft2/cat1-tool.cwl")
