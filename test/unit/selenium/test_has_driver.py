...
class TestNavigateTo:
    ...
    def test_navigate_to_outlasts_a_competing_navigation(self, has_driver_instance, base_url):
        """A page that redirects itself mid-flight must not strand navigate_to."""
        has_driver_instance.navigate_to(f"{base_url}/basic.html")
        has_driver_instance.click_selector("#navigate-away-later")
        ...
        has_driver_instance.navigate_to(f"{base_url}/slow/basic.html?requested=1")

        assert "requested=1" in has_driver_instance.current_url
