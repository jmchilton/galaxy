...
class TestOutputSchema:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("galaxy.tool_util.workflow_state.scripts.workflow_export_format2:main", "SingleExportReport"),
            ("galaxy.tool_util.workflow_state.scripts.workflow_export_format2_tree:main", "ExportTreeReport"),
