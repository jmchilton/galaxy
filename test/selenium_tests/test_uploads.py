...
PRJDA60709  SAMD00016382    DRX000480   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000775/DRR000775.fastq.gz""")
    ...
    def test_rules_example_5_matching_collections(self):
        ...
        self.rule_builder_add_value("PRJDB3920 FASTA")
        ...
        self.rule_builder_add_value("PRJDB3920 GFF3")
        ...
        self.rule_builder_split_columns(["C", "D", "E"], ["F", "G", "H"], screenshot_name="rules_example_3_8_split_columns")
        self.screenshot("rules_example_5_7_split")
    ...
    def test_rules_example_6_nested_lists(self):
        ...
        self.rule_builder_filter_count(1)
        self.rule_builder_add_regex_groups("L", 1, "([^\d]+)\d+", screenshot_name="rules_example_6_3_regex")
        self.rule_builder_set_mapping("list-identifiers", ["M", "A"], screenshot_name="rules_example_6_4_multiple_identifiers_edit")
        self.screenshot("rules_example_6_5_multiple_identifiers_")
