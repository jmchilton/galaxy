        ...
        response = self.dataset_collection_populator.upload_collection(history_id, "list:paired", elements=[
            {
                "name": "test0",
                "elements": [
                    {"src": "pasted", "paste_content": "123", "name": "forward"},
                    {"src": "pasted", "paste_content": "456", "name": "reverse"},
                ]
            },
            {
                "name": "test1",
                "elements": [
                    {"src": "pasted", "paste_content": "789", "name": "forward"},
                    {"src": "pasted", "paste_content": "0ab", "name": "reverse"},
                ]
            }
        ])
        self._assert_status_code_is(response, 200)
