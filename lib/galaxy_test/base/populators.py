...
class BaseDatasetPopulator(BasePopulator):
    ...
    def reimport_history(self, history_id, history_name, wait_on_history_length, export_kwds, api_key, task_based=False):
        ...
        if not task_based:
            ...
            self.wait_for_download_ready(storage_request_id)
            full_download_url = urllib.parse.urljoin(self.galaxy_interactor.api_url, f"api/short_term_storage/{storage_request_id}?key={api_key}")
...
class BaseWorkflowPopulator(BasePopulator):
    ...
    def create_invocation_from_store_raw(self, history_id: str, store_dict: Optional[Dict[str, Any]] = None, store_path: Optional[str] = None) -> Response:
    ...
    def create_invocation_from_store(self, history_id: str, store_dict: Optional[Dict[str, Any]] = None, store_path: Optional[str] = None) -> Response:
        create_response = self.create_invocation_from_store_raw(history_id, store_dict=store_dict, store_path=store_path)
