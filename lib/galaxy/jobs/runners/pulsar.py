...
KUBERNETES_DESTINATION_DEFAULTS: dict[str, Any] = {
    "k8s_enabled": True,
    **COEXECUTION_DESTINATION_DEFAULTS
}
...
class PulsarKubernetesPollingJobRunnerN(PulsarCoexecutionJobRunner):
    use_mq = False
    poll = True
    destination_defaults = KUBERNETES_DESTINATION_DEFAULTS
    client_manager_kwargs = KUBERNETES_CLIENT_MANAGER_KWARGS
...
class PulsarTesPollingJobRunner(PulsarCoexecutionJobRunner):
    destination_defaults = TES_DESTINATION_DEFAULTS
    client_manager_kwargs = TES_CLIENT_MANAGER_KWARGS
    use_mq = False
    poll = True
...
class PulsarGcpBatchPollingJobRunner(PulsarCoexecutionJobRunner):
    use_mq = False
    poll = True
