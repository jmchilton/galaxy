...
class PulsarJobRunner(AsynchronousJobRunner):
    ...
    def queue_job(self, job_wrapper):
        ...
        try:
            ...
            remote_pulsar_app_config = job_destination.params.get("pulsar_app_config", None)
            if remote_pulsar_app_config is None and "pulsar_app_config_file" in dest_params:
                pulsar_app_config_file = dest_params["pulsar_app_config_file"]
                with open(pulsar_app_config_file, "r") as fh:
