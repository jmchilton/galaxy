...
class HDAManager(
    ...
    def __init__(self, app: MinimalManagerApp, user_manager: users.UserManager, ldda_manager: lddas.LDDAManager, tag_handler: GalaxyTagHandler):
        """
    ...
    def materialize(self, request: MaterializeDatasetInstanceTaskRequest):
        ...
        new_hda = materializer.ensure_materialized(
            dataset_instance, target_history=history
        )
