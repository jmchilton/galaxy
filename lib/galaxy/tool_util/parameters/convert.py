...
def _encode_callback_for(encode_id: EncodeFunctionT) -> Callable[[ToolParameterT, Any], Any]:
...
def _decode_callback_for(decode_id: DecodeFunctionT) -> Callable[[ToolParameterT, Any], Any]:
