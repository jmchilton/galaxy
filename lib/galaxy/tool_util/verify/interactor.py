...
class GalaxyInteractorApi:
    ...
    def get_tool_tests(self, tool_id: str, tool_version: Optional[str] = None) -> "ToolTestCaseList":
...
def verify_tool(
    ...
    tool_test_dicts: List[ToolTestCase] = (
        _tool_test_dicts or galaxy_interactor.get_tool_tests(tool_id, tool_version=tool_version).__root__
    )
