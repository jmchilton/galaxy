...
class DefaultToolAction( object ):
    ...
    def _record_inputs( self, trans, tool, job, incoming, inp_data, inp_dataset_collections ):
        ...
        self._check_input_data_access( trans, job, inp_data )
...
class OutputCollections(object):
    ...
    def __init__(self, trans, history, tool, tool_action, mapping_over_collection, on_text, incoming, params, job_params):
        self.trans = trans
