...
class YamlToolSource(ToolSource):
    ...
    def _parse_output(self, tool, name, output_dict):
        ...
        output.dataset_collectors_descriptions = self.dataset_collectors_descriptions( output_dict )
        return output
    ...
    def _parse_output_collection(self, tool, name, output_dict):
        ...
        filters = []
        dataset_collectors_descriptions = self._dataset_collectors_descriptions( output_dict )

        structure = galaxy.tools.ToolOutputCollectionStructure(
            collection_type=collection_type,
            collection_type_source=collection_type_source,
            structured_like=structured_like,
            dataset_collectors_descriptions=dataset_collectors_descriptions,
        )
    ...
    def _dataset_collectors_descriptions(self, discover_datasets_dicts):
