...
class TestDataOutputAssertions(BaseTestOutputModel):
    ...
    visible: Annotated[
        ...
        Field(
            title="Visible",
            description="If set, assert the output dataset's visible flag matches this value.",
        ),
    ] = None
    deleted: Annotated[
        bool | None,
        Field(
            title="Deleted",
            description="If set, assert the output dataset's deleted flag matches this value.",
        ),
    ] = None
