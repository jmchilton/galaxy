...
def get_metadata_compute_strategy(app, job_id, metadata_strategy_override=None):
    metadata_strategy = metadata_strategy_override or app.config.metadata_strategy
