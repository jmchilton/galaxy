...
<<<<<<< HEAD
from galaxy.schema.schema import InvocationIndexPayload, Model
=======
...
>>>>>>> a099d0bf54 (Task based workflow invocation downloads.)
...
class WorkflowsAPIController(BaseGalaxyAPIController, UsesStoredWorkflowMixin, UsesAnnotations, SharableMixin, ServesExportStores, ConsumesModelStores):
