...
def upgrade():
    ...
    op.add_column("workflow_invocation", Column("preferred_object_store_id", preferred_object_store_type, default=None))
...
def downgrade():
    ...
    drop_column("workflow_invocation", "preferred_object_store_id")
