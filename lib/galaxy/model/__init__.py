...
class WorkflowInvocationStep(Base, Dictifiable, Serializable):
    ...
    def _serialize(self, id_encoder, serialization_options):
        ...
        if self.job:
            ...
            step_attrs["implicit_collection_jobs"] = self.implicit_collection_jobs.serialize(id_encoder, serialization_options, for_link=True)
        ...
        for output_dataset_collection_assoc in self.output_dataset_collections:
            ...
            if dataset_collection:
                output_collection["dataset_collection"] = dataset_collection.serialize(id_encoder, serialization_options, for_link=True)
...
class WorkflowRequestToInputDatasetAssociation(Base, Dictifiable, Serializable):
    ...
    def _serialize(self, id_encoder, serialization_options):
        ...
        request_input_dataset_attrs["dataset"] = self.dataset.serialize(id_encoder, serialization_options, for_link=True)
...
class WorkflowRequestToInputDatasetCollectionAssociation(Base, Dictifiable, Serializable):
    ...
    def _serialize(self, id_encoder, serialization_options):
        ...
        request_input_collection_attrs["dataset_collection"] = self.dataset_collection.serialize(id_encoder, serialization_options, for_link=True)
...
class WorkflowInvocationOutputDatasetCollectionAssociation(Base, Dictifiable, Serializable):
    ...
    def _serialize(self, id_encoder, serialization_options):
        ...
        output_collection_attrs["dataset_collection"] = self.dataset_collection.serialize(id_encoder, serialization_options, for_link=True)
