...
export default Backbone.View.extend({
    ...
    render: function() {
        ...
        const workflowRuntimeCompatible = this.field.workflowRuntimeCompatible === undefined ? true : this.field.workflowRuntimeCompatible;
        if (workflowRuntimeCompatible && !this.model.get("disabled") && this.model.get("collapsible_value") !== undefined) {
