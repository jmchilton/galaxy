...
* Interactive tours (with signficant help from
...
* Use Webpack to greatly optimize JavaScript and other assert served by Galaxy.
  `Pull Request 1144`_
* Add BAM iobio_ visualisation as a Galaxy Interactive Environment
  (thanks to `@bgruening <https://github.com/bgruening>`__.)
  `Pull Request 1131`_
* Procedures for bug and issue handling as well as roadmap management.
  `Pull Request 902`_, `Pull Request 1020`_
* Implement a conda dependency resolver (with signficant help from
  `@bgruening <https://github.com/bgruening>`__.)
...
* Enable configuration of client side logging.
  `Pull Request 1011`_
...
* Implement special config file to dump parameters as json.
  `Pull Request 1405`_
* Add google analytics tracking to new ata libraries.
  `Pull Request 959`_
...
* Add local grunt-cli dependency for qunit tests.
  `Pull Request 1159`_
* Allowed for capitalised package names such as R in unlinked tool shed
  depedency resolver
  (thanks to `@Christian-B <https://github.com/Christian-B>`__.)
  `Pull Request 1160`_
* A slew of tool execution performance enhancements including a huge
