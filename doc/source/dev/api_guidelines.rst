...
Consumer-facing API guidance should also be kept current in
:ref:`api-client-best-practices`. When a new API replaces a legacy pattern,
document both the new preferred route and the older pattern clients should
avoid.
